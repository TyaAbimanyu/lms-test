        ...
        <div class="row">
          <div class="col-xxl-6 offset-xl-3 col-xl-6 offset-xl-3">
              <div class="section__title-wrapper text-center mb-60">
                <h2 class="section__title">We are <span class="yellow-bg yellow-bg-big">Proud
                  <img src="/images/shape/yellow-bg.png" alt=""></span></h2>
                <p>You don't have to struggle alone, you've got our assistance and help.</p>
              </div>
          </div>
        </div>
        <div class="row">
          <div v-for="(c,i) in counter_data" :key="i" :class="c.col">
              <div :class="`counter__item ${c.pl ? c.pl : ''} mb-30`">
                <div :class="`counter__icon ${c.icon_name} mb-15`" v-html="c.icon"></div>
                <div class="counter__content">
                    <h4><span class="purecounter">{{ c.counter }}</span>{{ c.text }}</h4>
                    <p>{{ c.title }}</p>
                </div>
              </div>
          </div>
...
const counter_data = [
  {
    ...
    counter: 345421,
    icon: `<svg viewBox="0 0 490.7 490.7">
