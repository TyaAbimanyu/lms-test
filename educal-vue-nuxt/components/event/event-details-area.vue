<template>
  <section class="page__title-area pt-120">
    <div class="page__title-shape">
        ...
        <img class="page-title-shape-6" src="/images/page-title/page-title-shape-2.png" alt="">
        <img class="page-title-shape-7" src="/images/page-title/page-title-shape-4.png" alt="">
        <img class="page-title-shape-8" src="/images/page-title/page-title-shape-5.png" alt="">
    </div>
    <div class="container">
        <div class="row">
                ...
                <div class="page__title-breadcrumb">                            
                    <nav aria-label="breadcrumb">
                      <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><nuxt-link href="/courses">Event</nuxt-link></li>
              ...
              <div class="course__meta-2 d-sm-flex mb-30">
                <div class="course__teacher-3 d-flex align-items-center mr-70 mb-30">
                    <div class="course__teacher-thumb-3 mr-15">
                      <img src="/images/course/teacher/teacher-1.jpg" alt="">
                    </div>
              ...
              <div class="events__sidebar pl-70">
                <div class="events__sidebar-widget white-bg mb-20">
                    <div class="events__sidebar-shape">
                      <img class="events-sidebar-img-2" src="/images/events/event-shape-2.png" alt="">
                      <img class="events-sidebar-img-3" src="/images/events/event-shape-3.png" alt="">
                    </div>
                    <div class="events__info">
                      ...
                      <div class="events__join-btn">
                          <nuxt-link href="/contact" class="e-btn e-btn-7 w-100">Enroll <i class="far fa-arrow-right"></i></nuxt-link>
                      </div>
                    </div>
                </div>
                <div class="events__sidebar-widget white-bg">
                    <div class="events__sponsor">
                      ...
                      <div class="events__sponsor-thumb mb-35">
                          <img src="/images/events/sponsor-logo.png" alt="">
                      </div>
...
import type { IEventData } from '@/types/event-d-t';

defineProps<{event: IEventData}>();
</script>
