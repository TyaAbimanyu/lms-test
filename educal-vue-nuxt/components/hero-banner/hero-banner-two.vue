<template>
 <section class="hero__area hero__height hero__height-2 d-flex align-items-center blue-bg-3 p-relative fix">
    <div class="hero__shape">
        <img class="hero-1-circle" src="/images/shape/hero/hero-1-circle.png" alt="">
        <img class="hero-1-circle-2" src="/images/shape/hero/hero-1-circle-2.png" alt="">
        <img class="hero-1-dot-2" src="/images/shape/hero/hero-1-dot-2.png" alt="">
    </div>
    <div class="container">
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="hero__content hero__content-2 p-relative z-index-1">
                    <h3 class="hero__title hero__title-2">
                      Launch your <br> Own 
                      <span class="yellow-shape">online <img src="/images/shape/yellow-bg.png" alt="yellow-shape"> </span> 
                      learning Platform
                    </h3>
              ...
              <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                <div class="hero__thumb-wrapper mb--120">
                    <div class="hero__thumb-2 scene">
                      <img class="hero-big" src="/images/hero/hero-2/hero.png" alt="">
                      <img class="hero-shape-purple" src="/images/hero/hero-2/hero-shape-purple.png" alt="">
                      ...
                      <div class="hero__class d-none d-lg-flex layer" data-depth="0.3">
                          <div class="hero__class-thumb mr-15">
                            <img src="/images/hero/hero-2/hero-sm.jpg" alt="">
                          </div>
                          <div class="hero__class-text">
                            <h5>User Experience Class</h5>
                            <p>Tomorrow is our</p>
                            <nuxt-link href="/contact">Join Now</nuxt-link>
                          </div>
                      </div>
                      <div class="hero__mic">
                          <span>
