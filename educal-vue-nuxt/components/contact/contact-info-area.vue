<template>
 <section class="contact__area grey-bg-2 pt-120 pb-90 p-relative fix">
    <div class="contact__shape">
        <img class="contact-shape-5" src="/images/contact/contact-shape-5.png" alt="contact-shape">
        <img class="contact-shape-4" src="/images/contact/contact-shape-4.png" alt="contact-shape">
    </div>
    <div class="container">
        <div class="row">
          <div class="col-xxl-5 offset-xxl-1 col-xl-5 offset-xl-1 col-lg-5 offset-lg-1 col-md-6">
              <div class="contact__item text-center mb-30 transition-3 white-bg">
                ...
                <div class="contact__content">
                    ...
                    <nuxt-link href="/contact" class="e-btn e-btn-border">Visit Documentation</nuxt-link>
                </div>
              </div>
          </div>
          <div class="col-xxl-5 col-xl-5  col-lg-5 col-md-6">
              <div class="contact__item text-center mb-30 transition-3 white-bg">
                ...
                <div class="contact__content">
                    ...
                    <p>My good sir plastered cuppa barney cobblers mush argy bargy ruddy.</p>
                    <nuxt-link href="/contact" class="e-btn e-btn-border">Send a Ticket</nuxt-link>
                </div>
              </div>
          </div>
        </div>
