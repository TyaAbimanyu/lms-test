          ...
          <div class="col-xxl-7 col-xl-7 col-lg-6">
              <div class="contact__wrapper">
                <div class="section__title-wrapper mb-40">
                    <h2 class="section__title">Get in<span class="yellow-bg yellow-bg-big">touch
                      <img src="/images/shape/yellow-bg.png" alt=""></span>
                    </h2>
          ...
          <div class="col-xxl-4 offset-xxl-1 col-xl-4 offset-xl-1 col-lg-5 offset-lg-1">
              <div class="contact__info white-bg p-relative z-index-1">
                <div class="contact__shape">
                    <img class="contact-shape-1" src="/images/contact/contact-shape-1.png" alt="shape">
                    <img class="contact-shape-2" src="/images/contact/contact-shape-2.png" alt="shape">
                    <img class="contact-shape-3" src="/images/contact/contact-shape-3.png" alt="shape">
                </div>
