  ...
  <section class="services__area pt-115 pb-40">
    <div class="container">
          ...
          <div class="col-xxl-6 offset-xxl-3 col-xl-6 offset-xl-3">
              <div class="section__title-wrapper section-padding mb-60 text-center">
                <h2 class="section__title">Why an <span class="yellow-bg">scholercity 
                  <img src="/images/shape/yellow-bg-2.png" alt="yellow-bg">
        ...
        <div class="row">
          ...
          <div v-for="(s, i) in service_data" :key="i" class="col-xxl-3 col-xl-3 col-lg-3 col-md-6 col-sm-6">
              <div :class="`services__item ${s.bg} mb-30`">
                <div class="services__icon" v-html="s.icon"></div>
                <div class="services__content">
                    <h3 class="services__title"><nuxt-link href="/about">4,000 <br> Online courses</nuxt-link></h3>
                    <p>Arse over tit morish wind up gormless butty.!</p>

                    <nuxt-link href="/about" class="link-btn-2">
